...
(1) Журнал проекта, где собраны записи о процессе разработки всенаправленной платформы. У каждой записи в журнале есть следующие атрибуты: раздел, ветка и дата внесения записи.
У каждой записи в журнале есть следующие атрибуты: раздел, ветка и дата <br>
(2) Поле с заданиями <br> 
